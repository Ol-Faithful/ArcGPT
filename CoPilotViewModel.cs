...
namespace ArcGPT
{
    internal class CoPilotViewModel : DockPane
    {
        private const string _dockPaneID = "ArcGPT_CoPilot";
        private const string StartUri = "https://copilot.microsoft.com";
        private Uri _sourceUri = new(StartUri);
        private string _navInput = StartUri;

        protected CoPilotViewModel() { }
        ...
        /// </summary>
        private string _heading = "CoPilot DockPane";
    ...
    /// </summary>
    internal class CoPilot_ShowButton : Button
    {
        protected override void OnClick()
        {
            CoPilotViewModel.Show();
        }
    }
}
